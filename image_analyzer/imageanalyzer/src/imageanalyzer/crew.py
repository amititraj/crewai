...
from imageanalyzer.src.imageanalyzer.tools.image_tool import ImageTool
...
class Imageanalyzer():
    ...
    def vision_task(self) -> Task:
        return Task(
            config=self.tasks_config['vision_task'], # type: ignore[index]
        )    
    
    @crew
    def crew(self) -> Crew:
        """Creates the Imageanalyzer crew"""
